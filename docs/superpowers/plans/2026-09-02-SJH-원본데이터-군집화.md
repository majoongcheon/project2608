...
def test_join_by_value_tuple_붙인다():
    ...
    db = [
        {'relation_to_person': 1, 'help_needed_hours': 4, 'care_burden': 5,
         'split': 'test', 'cv_fold': None},
        {'relation_to_person': 2, 'help_needed_hours': 3, 'care_burden': 2,
    ...
    assert out[0]['cv_fold'] == 3
    assert out[1]['split'] == 'test'
